        ...
        children: [
          {
            path: 'singleland',
            name: 'Singleland',
            component: () => import('@/views/detection/soil-single-factor'),
            meta: { title: '土壤单因子' }
          },
          {
            path: 'multipleland',
            name: 'Multipleland',
            component: () => import('@/views/detection/soil-multi-factor'),
            meta: { title: '土壤多因子' }
          },
          {
            path: 'accumulation',
            name: 'Accumulation',
            component: () => import('@/views/detection/soil-lgeo'),
            meta: { title: '土壤地累计指数' }
          },
          {
            path: 'singlecrop',
            name: 'Singlecrop',
            component: () => import('@/views/detection/crop-single-factor'),
            meta: { title: '作物单因子' }
          }
        ]
      },
